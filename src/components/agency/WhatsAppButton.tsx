    ...
    <div className="fixed-buttons">
      <motion.a
        ...
        className="flex items-center justify-center rounded-full bg-green-500 text-white 
                  w-12 h-12 sm:w-14 sm:h-14 shadow-lg hover:bg-green-600 transition-all duration-300 
      ...
      <motion.a
        ...
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.9 }}
        className="sm:hidden flex items-center justify-center rounded-full bg-cyan-500 text-white 
                  w-12 h-12 shadow-lg hover:bg-cyan-600 transition-all duration-300
